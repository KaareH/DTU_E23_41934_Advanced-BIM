...
Though this is assingment 4, the working directory is, :code:`./some/path/to/DTU_E23_41934_Advanced-BIM/`.
...
Make sure you are in the working directory, :code:`./some/path/to/DTU_E23_41934_Advanced-BIM/`.
